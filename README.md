...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-05 12:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/acd62684-bc7b-480a-a015-b8208b5cf354.git
$ cd acd62684-bc7b-480a-a015-b8208b5cf354
```
